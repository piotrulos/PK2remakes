...
namespace TileEngine
{
    public static class TileMap
    {
        ...
        public const int MapHeight = 12; // do sprawdzenia
        ...
        #region Infirmation about Map Cells
        ...
        static public void Draw(SpriteBatch spriteBatch)
        {
            ...
            int endX= GetCellByPixelY((int)Camera.Position.X + Camera.ViewPortWidth);
            int startY = GetCellByPixelX((int)Camera.Position.Y);

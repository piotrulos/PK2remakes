...
namespace LevelEditor
{
    public partial class MapEditor : Form
    {
        ...
        {
            string filepatch = Application.StartupPath + @"\Content\Textures\tiles.png";
            Bitmap tileSheet = new Bitmap(filepatch);
            int tilecount = 0;
        ...
        private void MapEditor_Load(object sender, EventArgs e)
        {
            ...
            cboCodeValues.Items.Add("PointItem");
        ...
        private void backgroundToolStripMenuItem_Click(object sender, EventArgs e)
        {
            game.DrawLayer = 0;
            backgroundToolStripMenuItem.Checked = true;
            interacToolStripMenuItem.Checked = false;
            foregroundToolStripMenuItem.Checked = false;
        }

        private void interacToolStripMenuItem_Click(object sender, EventArgs e)
        {
            game.DrawLayer = 1;
            backgroundToolStripMenuItem.Checked = false;
            interacToolStripMenuItem.Checked =  true;
            foregroundToolStripMenuItem.Checked = false;
        }

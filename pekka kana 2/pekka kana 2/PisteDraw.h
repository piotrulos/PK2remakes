...
-First try to upgrage game engine to new version of directX
-First try to remake window settings menu based on new windows forms 
instead of winAPI -> Form1
...
#include <direct2D> // MUISTA KORJATA POLKU OIKEIN!!!!
#include <windows.h> 
